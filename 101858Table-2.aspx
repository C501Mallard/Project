<%@ Page Language="C#" AutoEventWireup="true" CodeFile="101858Table-2.aspx.cs" Inherits="_101858Table_2" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title></title>
    <%--使用 bootstrap 套用在Table上  此行記得要加，套見CSSClass才會用到--%> 
...
<body>
    ...
    <div class="table-responsive">
        ...
        <%--  幫GridView 加上 CssClass="table table-bordered table-hover table-striped"--%> 
        <asp:GridView CssClass="table table-bordered table-hover table-striped" ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
            <Columns>
                ...
                <asp:BoundField DataField="班級上課時間" HeaderText="班級上課時間" SortExpression="班級上課時間" />
