<%@ Page Language="C#" AutoEventWireup="true" CodeFile="usrhome.aspx.cs" Inherits="usrhome" %>
...
<body>
    <%--<asp:HyperLink runat="server" NavigateUrl="~/usrhome.aspx" CssClass="navbar-brand">使用者首頁2</asp:HyperLink>--%>
    <%--<asp:HyperLink runat="server" NavigateUrl="~/usrhome.aspx"><span class="fa fa-dashboard fa-fw"></span>Dashboard</asp:HyperLink>--%>
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li><a href="login.html"><span class="fa fa-sign-out fa-fw"></span>Logout</a>
                            </li>
                        </ul>
                        <!-- /.dropdown-user -->
                    </li>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="index.html"><span class="fa fa-dashboard fa-fw"></span>Dashboard</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="tables.html"><span class="fa fa-table fa-fw"></span>Tables</a>
                            </li>
                            <li>
                                <a href="forms.html"><span class="fa fa-edit fa-fw"></span>Forms</a>
                            </li>
                            <li>
                                <a href="#"><span class="fa fa-wrench fa-fw"></span>UI Elements<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                            ...
                            <li>
                                <a href="#"><span class="fa fa-sitemap fa-fw"></span>Multi-Level Dropdown<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                            ...
                            <li>
                                <a href="#"><span class="fa fa-files-o fa-fw"></span>Sample Pages<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <span class="fa fa-support fa-5x"></span>
                                    </div>
                                    <div class="col-xs-9 text-right">
